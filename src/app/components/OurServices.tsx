...
import { MdDesignServices, MdSpeed, MdVerifiedUser, MdUpdate } from 'react-icons/md';
...
const services = [
  ...
  },
  {
    ...
    path: '/services/mobile-responsive-designs',
  },
  {
  ...
  },
  {
    ...
    path: '/services/profile-updates-edits',
  },
  {
  ...
  },
  {
    ...
    path: '/services/profile-verification-assistance',
  },
  {
    ...
    icon: <RiMegaphoneLine className="text-4xl" style={{ color: rustyBrown }} />,
    path: '/services/profile-monitoring-support',
  },
];
