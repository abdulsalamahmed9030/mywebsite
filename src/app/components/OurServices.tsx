...
const services = [
  {
    ...
    icon: <MdDesignServices className="text-4xl text-[#f0b100]" />,
  },
  {
    ...
    icon: <FaLaptopCode className="text-4xl text-[#f0b100]" />,
  },
  {
    ...
    icon: <RiMegaphoneLine className="text-4xl text-[#f0b100]" />,
  },
  {
    ...
    icon: <FaChartLine className="text-4xl text-[#f0b100]" />,
  },
  {
    ...
    icon: <FaMobileAlt className="text-4xl text-[#f0b100]" />,
  },
  {
    ...
    icon: <MdSpeed className="text-4xl text-[#f0b100]" />,
  },
];
...
export default function OurServices() {
  return (
    <section
      className="relative z-10 py-16 px-4 sm:px-10 md:px-20 lg:px-32 text-center bg-black text-white bg-cover bg-center"
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {services.map((service, index) => (
            <motion.div
              key={index}
              className="bg-black/70 border border-[#f0b100] p-8 shadow-lg hover:shadow-yellow-500/30 transition duration-300 rounded-none md:rounded-2xl"
